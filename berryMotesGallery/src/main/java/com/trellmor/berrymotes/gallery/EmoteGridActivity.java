 ...
 */
public class EmoteGridActivity extends ActionBarActivity implements EmoteGridFragment.Callbacks,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!EmoteUtils.isBerryMotesInstalled(this, EmoteUtils.BERRYMOTES_VERSION_1_3_0)) {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_export:
			new AlertDialog.Builder(this).setTitle(R.string.title_export).setMessage(R.string.text_export)
